# -*- coding: utf-8 -*-
"""
Created on Sat Sep 25 20:13:40 2021

@author: Subhro Mukhejee, Siddhant Jain, Sutam Chandra
"""
...
def getJsonData(file, attr_ret, attr1, attr2, attr_val1, attr_val2):
	...
	for i in data:
		if(i[attr1]== attr_val1 and i[attr2]== attr_val2):retv.append(i[attr_ret])
	return retv
